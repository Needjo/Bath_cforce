% Configurational forces 2d problem - Bath 02.10.2014
% Mesh improvement by configurational force analysis. Example based on
% Mueller R., Kolling S., Gross D., "On configurational forces in the
% context of the finite element method". This example involves a 3 point 
% bending test. Procedure author: Nikola Lustig, mag.ing.aedif.
...
Rubni = [ 1 nlelemenata+1 ; 0 1 ; 0 0 ];


FV = zeros ( 2 * nC , 1 );

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Use this for a concentrated load
FV ( 2 * ( nC - ceil(nlelemenata/2) ) ) = Sila;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Use this for a distributed load
