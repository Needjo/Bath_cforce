...
[ xy , EL , nC , nEL , ~ , ~ , ~ , ~ , ~ , ~ , ~ , ~ , ~ ] = Q4_mesh_reader_extended ( textfilename );
...
if broj_koraka == 1 || rem ( broj_koraka , 15 ) == 0
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Plotting of configurational force vs. step number and J-integral
...
% Create plot
J_integral_an = ones ( 1,broj_koraka ) * J_integral_an; 

plot(1:broj_koraka, J_integral_num,'b-','LineWidth',2);
plot(1:broj_koraka , J_integral_an,'k--','LineWidth',2);
...
% Create ylabel
ylabel('$-G_y$','FontSize',20,'interpreter','latex');

% Create title
title('Change of configurational force through iterations',...
    'FontSize',24);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Plotting of normalised configurational force vs. step number and J-integral
...
% Create plot
Normalised_J_an = ones ( 1,broj_koraka ) * Normalised_J_an; 

plot(1:broj_koraka, Normalised_J_num,'b-','LineWidth',2);
plot(1:broj_koraka , Normalised_J_an,'k--','LineWidth',2);
...
% Create ylabel
ylabel('$\displaystyle\frac{-G_2 \mu}{\sigma_0^2 a}$','FontSize',20,'interpreter','latex');
...
Q4_Conf_force_to_VTK(nC,nEL,xy_popis(:,:,reshape(Usporedba_korak,1,length(Usporedba_korak))),EL,pomak_popis(:,reshape(Usporedba_korak,1,length(Usporedba_korak))),length(Usporedba_korak),Stress_point,Conf_popis(:,reshape(Usporedba_korak,1,length(Usporedba_korak))))
