...
End_node = find ( abs(xy ( 1 , : ) - lgrede)<0.001 & abs(round ( xy ( 2 , : ) *100 )/100 - hgrede/2) < 0.001 );
...
if broj_koraka == 1 || rem ( broj_koraka , 25 ) == 0
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Plotting of displacement vs. step number
...
% Create plot
% load Mueller2_100x100
% pomak_popis_normalised_100x100 = ones ( 1,broj_koraka ) * pomak_popis_normalised_100x100; 

plot(1:broj_koraka,pomak_popis_normalised,'b-','LineWidth',2);
% plot(1:broj_koraka , pomak_popis_normalised_100x100,'k--','LineWidth',2);
...
% Create ylabel
ylabel('$\displaystyle\frac{u G}{\sigma_0 L}$','FontSize',20,'interpreter','latex');

% Create title
title('Change of end node displacement through iterations',...
    'FontSize',24);
