% Configurational forces 2d problem - Bath 17.10.2014
% Mesh improvement by configurational force analysis. Example problem from
% Miehe C., Gurses E., "A robust algorithm for configurational-force-driven
% brittle crack propagation with R-adaptive mesh alignment" - 
% example 4.1.3.Single edge notched specimen under tension. 
